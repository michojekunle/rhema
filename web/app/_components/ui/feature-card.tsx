...
export function FeatureCard({
  ...
  return (
    <div
      className={cn(
        "hover:bg-surface relative flex h-full w-full flex-col items-center gap-4 border border-border bg-background p-8 text-center transition-colors duration-300 md:p-10",
        className
      )}
    >
      <Icon
